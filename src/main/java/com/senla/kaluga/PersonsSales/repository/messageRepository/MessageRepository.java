...
public class MessageRepository {
    ...
    //todo
    //нужно возвращать все сообщения, связанные с одним человечком. И желательно это сделать так, чтобы
    // возвращались только секьюрные. Т.е. читать объявления мог либоотправитель, либо получатель.
    // Это ограничим на уровне эндпоинтов
